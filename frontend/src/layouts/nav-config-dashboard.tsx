...
export const navData: NavSectionProps['data'] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: 'Syllabus',
        path: paths.main.syllabus,
        icon: ICONS.file,
        caption: 'View course syllabus and study materials',
        deepMatch: false,
      },
      {
        title: 'Learning Path',
        path: paths.main.learningPath,
        icon: ICONS.dashboard,
        caption: 'AI-powered personalized study plan',
        deepMatch: false,
      },
      {
        title: 'Counselling',
        path: paths.main.counselling,
        icon: ICONS.blog,
        caption: 'Get guidance from expert counselors',
        deepMatch: false,
      },
      {
        title: 'Chat',
